...
if __name__ == "__main__":
    ...
    #llm.import_ckpt(model=llm.LlamaModel(llm.Llama2Config7B()), source='hf://elyza/ELYZA-japanese-Llama-2-7b', 
    #                output_path='./models/ELYZA-japanese-Llama-2-7b', overwrite=True)
    ...
    recipe = llm.llama2_7b.finetune_recipe(
        dir="./models/checkpoints/ELYZA-japanese-Llama-2-7b",  # Path to store checkpoints
        name="elyza_lora",
        num_nodes=1,
        num_gpus_per_node=1,
        peft_scheme="lora",
    ...
    recipe.resume.restore_config = run.Config(
        nl.RestoreConfig,
        path='./models/ELYZA-japanese-Llama-2-7b'
    )
