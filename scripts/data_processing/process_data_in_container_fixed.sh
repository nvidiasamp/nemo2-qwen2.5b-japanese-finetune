...
echo ""
echo "📚 Reference: Based on NVIDIA NeMo Framework Japanese continual pre-training guide"
echo "   https://developer.nvidia.com/ja-jp/blog/how-to-use-continual-pre-training-with-japanese-language-on-nemo-framework/"